...
export default function Footer(){
    ...
    return<> <div className="grid grid-cols-3 py-10 px-6 text-xl bg-zinc-800 text-zinc-400 border border-b border-zinc-500">
              ...
              <div className="info col-span-2  flex justify-around items-center ">
                    <ul className="col-span-1">
                        <li className="font-bold mb-3 text-2xl">رادیو تبریز</li>
                        <li>درباره ما</li>
                        <li>ارتباط با ما</li>
                        <li>مراکز</li>
                    </ul>
                    <ul className="col-span-1">
                        <li className="font-bold mb-3 text-2xl">اطلاعات</li>
                        <li>لغوسفارش</li>
                        <li>بازگشت سفارش</li>
                        <li>گارانتی</li>
                    </ul>
           ...
           <div className="bg-zinc-800 text-zinc-400 flex items-center justify-between py-5 px-6">
